...
public partial class PageWeb : ContentPage
{
    ...
    public PageWeb()
	{
        ...
        string wURL = clsGlobalVar.GetCurURL() + "users/dailyreports/" + clsGlobalVar.GetLanguageStr() + "/" + clsGlobalVar.
            g_UserID + "/" + DateTime.Now.ToString("yyyy-MM-dd");
...
//                                label1,
    ...
    {
        clsGlobalVar.g_BackPage = "PageWeb";
        freeThis();
    ...
    async void EndButtonClicked(object sender, EventArgs s)
    {
        if (doingNow == false)
        {
            ...
            if (doingNow == false)
            {
                ...
                if (clsGlobalVar.g_JumpPage == "")
                {
                    strJump = "Page2";
                }
                else
                {
                    strJump = clsGlobalVar.g_JumpPage;
                }
