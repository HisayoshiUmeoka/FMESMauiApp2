================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: InitLic プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した InitLic には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには InitLic アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
InitLic.h
   ...
   CInitLicApp アプリケーション クラスを宣言します。

InitLic.cpp
   これは、アプリケーション クラス CInitLicApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\InitLic.ico
   ...
   アイコンはメイン リソース ファイル InitLic.rc に含まれていま
   す。
...
InitLicDlg.h, InitLicDlg.cpp - ダイアログ
   これらのファイルは CInitLicDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な InitLic.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   InitLic.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
