========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : LicBack
========================================================================


AppWizard が生成した LicBack には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには LicBack を構成している各ファイルの概要説明が含まれています。
...
LicBack.h
    ...
    みます） をインクルードし、また CLicBackApp アプリケーションクラスを宣
    言します。

LicBack.cpp
    このファイルは CLicBackApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\LicBack.ico
    ...
    ルです。このアイコンはリソース ファイル LicBack.rc によってインクルード
    されます。
...
LicBackDlg.h, LicBackDlg.cpp - ダイアログ
    これらのファイルは CLicBackDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な LicBack.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) LicBack.pch 
